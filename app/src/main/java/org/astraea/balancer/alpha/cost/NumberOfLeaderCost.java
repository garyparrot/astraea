...
public class NumberOfLeaderCost implements HasBrokerCost {
    ...
    public Fetcher fetcher() {
        return client -> new java.util.ArrayList<>(KafkaMetrics.ReplicaManager.LeaderCount.fetch(client));
    }
    ...
    public BrokerCost brokerCost(ClusterInfo clusterInfo) {
        ...
        clusterInfo.allBeans().forEach((key, value) -> value
                .stream()
        ...
        leaderCount.forEach((broker,leaderNum)->{
