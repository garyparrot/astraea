...
public class BalancerBuilder {
   ...
   * which means any cost function that requires metrics to operate won't work. To use a cost
   * function with metric requirement, one must specify the concrete bean metric source.
   *
